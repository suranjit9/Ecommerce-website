                ...
                <div className="md:flex w-full">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        ...
                        <form onSubmit={hendalEmail}>
                            <div className="flex -mx-3">
                                ...
                                <div className="w-1/2 px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                        <input type="text" name="lastName" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
                        ...
                        <div className="flex gap-3">
                                <button onClick={googleSingup} className="btn btn-outline w-1/2 ">Google </button>
                                <button className="btn btn-outline w-1/2">Google </button>
                        </div>
                        <div className="flex gap-2 justify-center mt-4">
                            <h1>Alredy have an Account Please </h1>
                            <Link to={'/login'}><p  className="text-green-600 font-bold">Log in</p></Link>
                        </div>
                    </div>
                </div>
            </div>
