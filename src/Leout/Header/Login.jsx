            ...
            <div className="md:flex w-full">
                ...
                <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div className="text-center mb-10">
                        <h1 className="font-bold text-3xl text-gray-900">Sing in</h1>
                        <p>Enter your information to Sing in</p>
                    </div>
                    <form onSubmit={handalEmailSing}>
                    ...
                    <div className="mt-4 mb-4 text-center">
                            <h2 className="text-xl font-bold border-x-4 border-red-600 ">Sing is with </h2>
                    </div>
                    <div className="flex gap-3">
                            <h3 onClick={handelGoogle} className="btn btn-outline w-1/2 items-center "><span className="text-xl m-0"><FcGoogle /></span>google</h3>
                            <h3 className="btn btn-outline w-1/2 items-center "><span className="text-xl m-0"><FcGoogle /></span>google</h3>
                           
                    </div>
                    <div className="flex gap-2 justify-center mt-4">
                        <h1>Alredy have an Account Please </h1>
                        <Link to={'/singUp'}><p  className="text-green-600 font-bold">Sing Up</p></Link>
                    </div>
                </div>
            </div>
        </div>
